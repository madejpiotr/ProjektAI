...
<header>
    ...
    <main role="main">
        ...
        <section class="jumbotron text-center">
            <div class="container">
                <h1 class="h1">Edytuj restauracje</h1>
            </div>
        </section>

        <div class="album py-5 bg-light">
            <div class="container">
            <form method="POST" action="{{ route('restaurant.update', $restaurant) }}" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="mt-2 mb-3 mr-5 ml-5">
                ...
                <input id="address" name="address" type="text" class="form-control @if ($errors->first('address')) is-invalid @endif" value="{{ $restaurant->address }}" 
                    placeholder="Adres">
                <div class="invalid-feedback">Nieprawidłowy adres!</div>
            </div>
            <div class="mt-2 mb-3 mr-5 ml-5">
                <label for="exampleFormControlInput1">Ocena</label>
                <input id="stars" name="stars" type="number" class="form-control @if ($errors->first('stars')) is-invalid @endif" value="{{ $restaurant->stars }}">
                <div class="invalid-feedback">Nieprawidłowa ocena!</div>
            </div>
            <div class="mt-2 mb-3 mr-5 ml-5">
                <label for="exampleFormControlInput1">Srednia cena</label>
                <input id="price" name="price" type="number" class="form-control @if ($errors->first('price')) is-invalid @endif" value="{{ $restaurant->price }}" 
            ...
            <div class="mt-2 mb-3 mr-5 ml-5">
                ...
                <input id="img" name="img" type="text" class="form-control @if ($errors->first('img')) is-invalid @endif" value="{{ $restaurant->img }}" 
                    placeholder="Sciezka">
                <div class="invalid-feedback">Nieprawidłowa ścieżka!</div>
            </div>      
            <div class="mt-2 mb-3 mr-5 ml-5">
                <label for="exampleFormControlInput1">Opis</label>
                <input id="description" name="description" type="text" class="form-control @if ($errors->first('description')) is-invalid @endif" value="{{ $restaurant->description }}" rows="3"></i>

        ...
        <div class="album py-5 bg-light">
            <div class="container">
                ...
                <div class="mt-2 mb-3 mr-5 ml-5">
                    ...
                    <input id="stars" name="stars" type="number" class="form-control @if ($errors->first('stars')) is-invalid @endif" value="{{ old('stars') }}" 
                        placeholder="Ocena">
                ...
                <div class="mt-2 mb-3 mr-5 ml-5">
                    ...
                    <textarea id="description" name="description" class="form-control @if ($errors->first('description')) is-invalid @endif" value="{{ old('description') }}" rows="3"></textarea>
